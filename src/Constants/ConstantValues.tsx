...
export const applicationTypes: ApplicationDataType['type'][] = ["PORTAL", "WINDOWS_LOGIN", "MAC_LOGIN", "WEB", "LINUX_LOGIN", "RADIUS", "REDMINE", "MICROSOFT_ENTRA_ID", "KEYCLOAK", "LDAP", "JENKINS"] 
export const docsApplicationTypes: (ApplicationDataType['type'] | 'LINUX_SSH_ROCKY')[] = ["PORTAL", "WINDOWS_LOGIN", "MAC_LOGIN", "WEB", "LINUX_LOGIN", "LINUX_SSH_ROCKY", "RADIUS", "REDMINE", "MICROSOFT_ENTRA_ID", "KEYCLOAK", "LDAP", "JENKINS"] 
