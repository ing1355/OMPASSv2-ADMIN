            ...
            <div className="policy-input-container">
                <div className="policy-contents-container column">
                    <div className="notice-row-container themselves">
                        ...
                        <Switch checked={value.methods.includes('PUSH')} disabled checkedChildren={'ON'} unCheckedChildren={'OFF'} />
                    </div>
                    <div className="notice-row-container themselves">
                        <div>
                            이메일(선택)
                        </div>
                        <Switch checked={value.methods.includes('EMAIL')} checkedChildren={'ON'} unCheckedChildren={'OFF'} onChange={check => {
                            if (check) {
                                onChange({
