const ServerErrorCodes = {
    'KR': {
        ...
        ERR_B013: "OMPASS를 제외한 다른 인증 장치 등록은 OMPASS를 등록한 후 가능합니다.",
        ERR_B014: "잘못된 키 값 입니다.",
        ERR_B015: "해당 어플리케이션 인증장치 등록 시 Portal 계정에 인증장치를 먼저 등록해야 합니다.",
    ...
    'EN': {
        ...
        ERR_B013: "After registering ompass, you can register other authentication devices",
        ERR_B014: "Invalid secret key",
        ERR_B015: "When registering an authentication device in an application other than the ADMIN application, you can first sign up (register) on the portal and then register",
