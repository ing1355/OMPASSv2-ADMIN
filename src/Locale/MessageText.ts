const MessageText = {
    'KR': {
        ...
        NO_CONNECTED_RADIUS_APPLICATION_MSG: '연결된 Radius 어플리케이션이 없습니다.',
        ...
        PLEASE_SELECT_APPLICATION_TYPE_MSG: '어플리케이션 유형은 필수 선택 사항입니다.',
        ...
        PLEASE_SETTING_NOTI_TO_ADMIN_POLICY_MSG: '위반 시 관리자 알림의 알림 방식을 1개 이상 설정해주세요.',
        PLEASE_SETTING_NOTI_TO_ADMIN_ONE_MORE_MSG: '위반 시 관리자 알림의 알림 받을 관리자를 1명 이상 설정해주세요.',
        NOTI_TO_ADMIN_INCLUDE_WITHDRAWAL_ADMIN_MSG: '위반 시 관리자 알림의 알림 받을 관리자에 이미 탈퇴한 관리자가 포함되어 있습니다. 해당 관리자를 제외시켜 주세요.',
        PLEASE_SETTING_NOTI_TO_ADMIN_POLICY_ONE_MORE_MSG: '위반 시 관리자 알림의 알림 대상 정책을 1개 이상 설정해주세요.',
        ...
        PASSCODE_RE_SEND_SUCCESS_MSG: '패스코드를 사용자 이메일로 재발송하였습니다.',
    ...
    'EN': {
        ...
        USER_AUTHORITY_SUCCESSION_SUCCESS_MSG: 'The succession of authority was successful. Please log in again to use the portal.'
    }
}
