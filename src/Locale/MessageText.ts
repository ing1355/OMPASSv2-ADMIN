const MessageText = {
    'KR': {
        ...
        APPLICATION_SECRET_KEY_COPY_FAIL_MSG: '시크릿 복사에 실패하였습니다.',
        APPLICATION_DELETE_SUCCESS_MSG: '어플리케이션 삭제에 성공하였습니다.',
        GROUP_ADD_SUCCESS_MSG: '그룹 생성에 성공하였습니다.',
        ...
        USER_ADD_SUCCESS_MSG: '사용자 등록에 성공하였습니다.',
    ...
    'EN': {
        ...
        APPLICATION_MODIFY_SUCCESS_MSG: '미번역',
        APPLICATION_ADD_SUCCESS_MSG: '미번역',
        APPLICATION_CLIENT_ID_COPY_SUCCESS_MSG: '미번역',
        APPLICATION_CLIENT_ID_COPY_FAIL_MSG: '미번역',
        APPLICATION_SECRET_KEY_COPY_SUCCESS_MSG: '미번역',
        APPLICATION_SECRET_KEY_COPY_FAIL_MSG: '미번역',
        APPLICATION_DELETE_SUCCESS_MSG: '미번역',
        GROUP_ADD_SUCCESS_MSG: '미번역',
        GROUP_MODIFY_SUCCESS_MSG: '미번역',
        GROUP_MODIFY_DELETE_MSG: '미번역',
        PASSCODE_COPY_SUCCESS_MSG: '미번역',
        PASSCODE_COPY_FAIL_MSG: '미번역',
        SEND_CODE_NEED_EMAIL_SEND_FIRST: '미번역',
        NEED_CODE_VERIFY_MSG: '미번역',
        EMAIL_SEND_FOR_CODE_VERIFY_SUCCESS_MSG: '미번역',
        SIGNUP_CODE_VERIFY_SUCCESS_MSG: '미번역',
        PASSCODE_DELETE_SUCCESS_MSG: '미번역',
        SIGNUP_APPROVE_SUCCESS_MSG: '미번역',
        USER_ADD_SUCCESS_MSG: '미번역',
        USER_MODIFY_SUCCESS_MSG: '미번역',
        USER_ID_EXIST_CHECK_SUCCESS_MSG: '미번역',
        USER_ID_EXIST_CHECK_FAIL_MSG: '미번역',
        PASSCODE_ADD_SUCCESS_MSG: '미번역',
        USER_UNLOCK_SUCCESS_MSG: '미번역',
        USER_WITHDRAWAL_SUCCESS_MSG: '미번역',
        USER_AUTH_DEVICE_UNREGISTER_SUCCESS_MSG: '미번역',
        EXCEL_UPLOAD_SUCCESS_MSG: '미번역',
        EXCEL_UPLOAD_FAIL_MSG: '미번역',
    }
}
