const LocaleTexts = {
  'en': {
    ...
    ONCE: 'once',
    TIMES: 'times',
    PASSCODE_MANAGEMENT: 'Passcode History',
    PASSCODE_MANAGEMENT_HISTORY: 'Passcode History',
    user_type: 'type',
    USER_TYPE: 'User Rank',
    APPLY: 'Apply',
    EDIT_: 'Edit',
    ...
    "Samsung Browser Mobile": "Samsung Browser Mobile",
  ...
  'ko': {
    ...
    ONCE: '1번',
    TIMES: '번',
    PASSCODE_MANAGEMENT: '패스코드 이력',
    PASSCODE_MANAGEMENT_HISTORY: '패스코드 이력',
    user_type: '타입',
    USER_TYPE: '사용자 등급',
    APPLY: '적용',
    EDIT_: '변경',
    ...
    "Samsung Browser Mobile": "삼성 브라우저 모바일",
