const LocaleTexts = {
  ...
  'ko': {
    ...
    DASHBOARD_LOCKED: '잠김',
    DASHBOARD_ALL_AUTH_SUM: '선택한 어플리케이션의 전체 인증 요청 수',
    DASHBOARD_ALL_AUTH: '각 어플리케이션의 인증 요청 횟수',
    DASHBOARD_INVALID_ALL_AUTH_SUM: '선택한 어플리케이션의 전체 비정상 인증 요청 횟수',
    DASHBOARD_INVALID_ALL_AUTH: '각 어플리케이션의 비정상 인증 요청 횟수',
    DASHBOARD_RECENT_INVALID_LOGS: '최근 비정상 인증 요청 로그',
    DASHBOARD_REGISTER_USER_NUMS: '어플리케이션별 등록 사용자 수',
    DASHBOARD_NOT_REGISTER_USER_NUMS: '어플리케이션별 미등록 사용자 수',
