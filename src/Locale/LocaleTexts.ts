const LocaleTexts = {
  'en': {
    ...
    GOOROOM_LOGIN_APPLICATION_TYPE: "Gooroom login",
  ...
  'ko': {
    ...
    USERNAME_CHECK: '4~16자의 영소문자 및 숫자만 사용 가능합니다',
    EMAIL_CHECK: '올바른 이메일 형식이 아닙니다',
    NAME_CHECK: '한글, 영문, 숫자로 입력해주세요',
    FIRST_NAME_CHECK: '한글, 영문, 숫자로 입력해주세요',
    LAST_NAME_CHECK: '한글, 영문, 숫자로 입력해주세요',
    ...
    PASSCODE: 'PASSCODE',
    APPLICATION_MANAGEMENT: '어플리케이션 관리',
    ...
    RADIUS_APPLICATION_TYPE: "Radius",
    GOOROOM_LOGIN_APPLICATION_TYPE: "구름 로그인",
    REDMINE_APPLICATION_TYPE: '레드마인',
