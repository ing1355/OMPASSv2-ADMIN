const LocaleTexts = {
  'en': {
    ...
    REGISTER_A_SECRET_KEY: 'Register a secret key',
    MODIFY_THE_SECRET_KEY: 'Modify the secret key',
    ...
    THE_FILE_SIZE_EXCEEDS_20MB: 'The file size exceeds 20 MB',
  ...
  'ko': {
    ...
    THE_FILE_SIZE_EXCEEDS_20MB: '파일 용량(20MB)을 초과하였습니다',
