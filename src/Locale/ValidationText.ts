const ValidationText = {
    ...
    'EN': {
        ...
        PLEASE_SELECT_APPLICATION_TYPE: '',
        PLEASE_INPUT_APPLICATION_NAME: '',
        PLEASE_INPUT_APPLICATION_DOMAIN: '',
        PLEASE_INPUT_APPLICATION_REDIRECT_URI: '',
        PLEASE_SELECT_APPLICATION_POLICY: '',
        IMAGE_FILE_UPLOADED_SIZE_EXCEEDS_1MB: '',
        IMAGE_FILE_UPLOADED_INVALID_FILE_FORMAT: '',
        CALENDAR_PLEASE_SELECT_DATE_RANGE: '',
        CALENDAR_MAXIMUM_RANGE_DATE_INVALID_MSG: '',
        PLEASE_INPUT_GROUP_NAME: '',
        PLEASE_INPUT_ID: '',
        PLEASE_INPUT_FIRST_NAME: '',
        PLEASE_INPUT_LAST_NAME: '',
        PLEASE_INPUT_EMAIL: '',
        PASSCODE_NEED_9_DIGIT_NUMBERS: '',
        PASSCODE_NEED_MORE_THAN_1_MINUTES: '',
        PASSCODE_NEED_MORE_THAN_1_TIMES: '',
        UPLOAD_NEED_ACCEPT_TYPE: '{param} 형식의 파일만 업로드 가능합니다.',
        UPLOAD_NEED_UNDER_10_MB_FILE: '10MB 미만의 파일만 업로드 가능합니다.'
    }
}
