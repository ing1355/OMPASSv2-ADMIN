const ValidationText = {
    'KR': {
        ...
        PHONE_NUMBER_CHECK: '전화번호는 숫자와 "-" 문자로만 입력해주세요.',
        ...
        PLEASE_INPUT_PASSWORD_CONFIRM: '비밀번호 확인을 입력해주세요.',
        ...
        PLEASE_INPUT_FIRST_NAME: '이름을 입력해주세요.',
        PLEASE_INPUT_LAST_NAME: '성을 입력해주세요.',
